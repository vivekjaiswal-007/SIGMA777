    ...
    <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
      ...
      {view === 'home' && (
        <>
          ...
          {/* Balance */}
          <div style={{ padding: '12px 16px', background: 'rgba(224,48,48,0.08)', border: '1px solid rgba(224,48,48,0.2)', borderRadius: '10px', marginBottom: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
